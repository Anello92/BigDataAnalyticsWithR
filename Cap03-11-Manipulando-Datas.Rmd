...
hoje <- Sys.Date() # Buscar data atual do sistema
hoje
class(hoje)
Sys.time()
Sys.timezone()
...
# Função format()
Sys.Date() # Obter a data do sistema
?format
format(Sys.Date(), format = "%d %B, %Y") # converter a data atual no formato DESEJADO
...
class(mydates) = c('POSIXt','POSIXct') # mãe e filho
mydates
class(mydates)
...
# Função ISODate - ajuda a colocar a data em formato iso
