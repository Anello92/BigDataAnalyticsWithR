...
---
                ...
                # Visualizações Interativas com Google
...
# O resultado é gerado em HTML5 ou Flash, plot direto no browser


# Pode-se criar os mais variados tipos de gráficos e mapas. Inclusive Google Maps
# Possível incorporar os gráficos criados em páginas HTML ou apps
...
# Gráfico de Linha - gvisLineChart()
...
# Gráficos Combinados barras e linha
...
# Bubble - Ótimo gráfico para relacionamento e peso de variáveis
